...
class MySQLHandler extends AbstractProcessingHandler
{
    ...
    private function initialize()
    {
        $this->pdo->exec(
            ...
            .'(id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY, channel VARCHAR(255), level INTEGER, message LONGTEXT, time TIMESTAMP, INDEX(channel) USING HASH, INDEX(level) USING HASH, INDEX(time) USING BTREE)'
        );
